...
## 주의
- 쿨다운 기본 감각은 "짧고 자주 발동"이다. 생략 시 컴파일러 기본값은 1.0초이며, 초반 단일타 0.8~1.2초, 초반 광역/보스 2.0~3.2초, 중반 핵심 3.0~5.0초, 버프는 duration 이하 또는 duration+1초 이내, 궁극기/대형 연출도 보통 5.5~8.0초에 둔다.
- 8초 초과 쿨다운은 예외다. 보스 원샷, 화면 전체 정지급 연출, 경제 보상 폭발처럼 이유가 명확할 때만 사용하고 이유를 YAML 주석이나 리뷰 노트에 남긴다.
