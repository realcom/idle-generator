...
namespace Google.Protobuf.Collections
{
    ...
    public sealed class MapField<TKey, TValue> : IDeepCloneable<MapField<TKey, TValue>>, IDictionary<TKey, TValue>, IEquatable<MapField<TKey, TValue>>, IDictionary, IReadOnlyDictionary<TKey, TValue>
    {
        ...
        /// <summary>
        /// Removes all entries from the map that satisfy the given predicate.
        /// </summary>
        /// <param name="predicate">The predicate to apply to each entry. If the predicate returns <c>true</c>, the entry is removed.</param>
        /// <remarks>
        /// This method is not optimized for large maps. If you need to remove many entries from a large map, consider
        /// creating a new map and adding the entries you want to keep.
        /// </remarks>
        ...
        private TKey PairKeyProjection(KeyValuePair<TKey, TValue> pair) => pair.Key;

        private MapKeysView _keys;
        /// <summary>
        /// Gets a collection containing the keys in the map.
        /// </summary>
        public MapKeysView Keys => _keys ??= new MapKeysView(this);
        ...
        private TValue PairValueProjection(KeyValuePair<TKey, TValue> pair) => pair.Value;

        private MapValuesView _values;
        /// <summary>
        /// Gets a collection containing the values in the map.
        /// </summary>
        public MapValuesView Values => _values ??= new MapValuesView(this);
        ...
        /// </returns>
        public LinkedList<KeyValuePair<TKey, TValue>>.Enumerator GetEnumerator() => list.GetEnumerator();
        ...
        public class MapKeysView : ICollection<TKey>, ICollection
        {
            private readonly MapField<TKey, TValue> parent;

            internal MapKeysView(MapField<TKey, TValue> parent)
            {
                this.parent = parent;
            }
            ...
            public IEnumerator<TKey> GetEnumerator() => new Enumerator(parent.list);
            ...
            public struct Enumerator : IEnumerator<TKey>, IEnumerator
            {
                ...
                internal Enumerator(LinkedList<KeyValuePair<TKey, TValue>> list)
                {
        ...
        public class MapValuesView : ICollection<TValue>, ICollection
        {
            private readonly MapField<TKey, TValue> parent;

            internal MapValuesView(MapField<TKey, TValue> parent)
            {
                this.parent = parent;
            }
            ...
            public Enumerator GetEnumerator() => new(parent.list);
            IEnumerator<TValue> IEnumerable<TValue>.GetEnumerator() => new Enumerator(parent.list);
