...
namespace Google.Protobuf.Collections
{
    ...
    public sealed class RepeatedField<T> : IList<T>, IList, IDeepCloneable<RepeatedField<T>>, IEquatable<RepeatedField<T>>, IReadOnlyList<T>
    {
        public struct Enumerator : IEnumerator<T>
        {
            ...
            {
                if (_index < _repeatedField.count)
                {
                    _current = _repeatedField.array[_index++];
                    return true;
                }
        ...
        private static readonly IEnumerator<T> EmptyEnumerator = ((IEnumerable<T>)EmptyArray).GetEnumerator();
        ...
        /// </returns>
        IEnumerator<T> IEnumerable<T>.GetEnumerator() => Count == 0 ? EmptyEnumerator : GetEnumerator();
