...
public abstract class ZUIBehaviour : ZMonoBehaviour
{
	public bool isStorable = false;
	public string saveKey = "";
	public string GetGamePrefsKey(string key) => $"{key}_{saveKey}";
    ...
    protected override void OnValidate()
    {
	    ...
	    if (isStorable && string.IsNullOrEmpty(saveKey))
		    saveKey = $"{Random.value.ToString(CultureInfo.InvariantCulture)[2..]}";
    }
