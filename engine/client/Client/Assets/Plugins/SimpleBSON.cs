...
{
    public class BSONValue : ICloneable
    {
		...
		*/
        ...
        {
            var target = new BSONValue();
            target.mValueType = mValueType;
            target._binary = _binary;
            target._bool = _bool;
            target._dateTime = _dateTime;
            target._int32 = _int32;
            target._int64 = _int64;
            target._double = _double;
            target._string = _string;
    ...
    public class BSONObject : BSONValue, IEnumerable
    {
        ...
        public override BSONValue this[string key]
        {
            get
            {
                ...
                mMap.TryGetValue(key, out value);
        ...
        public override object Clone()
        {
            ...
            {
                obj[key] = (BSONValue)mMap[key].Clone();
            }
    ...
    public class SimpleBSON
    {
        ...
        public static BSONObject Load(MemoryStream s)
        {
            SimpleBSON bson = new SimpleBSON(s);
        ...
        private SimpleBSON(MemoryStream ms)
        {
            mMemoryStream = ms;
            mBinaryReader = new BinaryReader(mMemoryStream);
        }
