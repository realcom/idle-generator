...
using UnityEngine;
using DesamplingRate = StaticBlurCapture.DesamplingRate;

/// <summary>
/// StaticBlurCapture editor.
/// </summary>
[CustomEditor(typeof(StaticBlurCapture))]
[CanEditMultipleObjects]
public class StaticBlurCaptureEditor : RawImageEditor
{
	//################################
	...
	public override void OnInspectorGUI()
	{
		...
		DrawEffectProperties(StaticBlurCapture.shaderName, serializedObject);
		...
		using (new EditorGUILayout.HorizontalScope(EditorStyles.helpBox))
		{
			...
			EditorGUI.BeginDisabledGroup(!(target as StaticBlurCapture).capturedTexture);
	...
	public static void DrawEffectProperties(string shaderName, SerializedObject serializedObject)
	{
		...
		if (spBlurMode.intValue != (int)StaticBlurCapture.BlurMode.None)
		{
		...
		{
			spMaterial.objectReferenceValue = StaticBlurCapture.GetOrGenerateMaterialVariant(Shader.Find(shaderName),
				(StaticBlurCapture.BlurMode)spBlurMode.intValue
			);
		}
	}
	...
	void DrawDesamplingRate(SerializedProperty sp)
	{
		using (new EditorGUILayout.HorizontalScope())
		{
			...
			int w, h;
			(target as StaticBlurCapture).GetDesamplingSize((DesamplingRate)sp.intValue, out w, out h);
	...
	{
		var current = target as StaticBlurCapture;
