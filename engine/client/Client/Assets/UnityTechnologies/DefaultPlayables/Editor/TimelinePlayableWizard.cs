...
public class TimelinePlayableWizard : EditorWindow
{
    ...
    [FormerlySerializedAs("isStandardBlendPlayable")] public bool isSkillPlayable;
    ...
    private static readonly Color defaultTrackColor = new Color(0.855f, 0.8623f, 0.870f);
    ...
    readonly GUIContent m_SkillPlayableContent = new("Skill Playable", "스킬에서 사용할 Custom Playable. 기본적으로 유닛에 붙일 때 사용");
    ...
    */
    ...
    {
        trackColor.r = UnityEngine.Random.Range(0f, 1f);
        trackColor.g = UnityEngine.Random.Range(0f, 1f);
        trackColor.b = UnityEngine.Random.Range(0f, 1f);
    }
    ...
    void OnGUI ()
    {
        ...
        if(showHelpBoxes)
        {
            EditorGUILayout.HelpBox(m_SkillPlayableContent.tooltip, MessageType.Info);
            EditorGUILayout.Space();
        }
        isSkillPlayable = EditorGUILayout.Toggle (m_SkillPlayableContent, isSkillPlayable);
        EditorGUILayout.EndVertical ();
    ...
    CreationError CreateScripts ()
    {
        ...
        AssetDatabase.CreateFolder (rootPath, playableName);
        ...
        if (m_CreateDrawer)
        {
            ...
            string path = getRootPath + "/Editor/" + playableName + k_PropertyDrawerSuffix + ".cs";
    ...
    private const string rootPath = "Assets/Scripts/Playables";
    private static string getRootPath => Application.dataPath + "/Scripts/Playables/"; 
    ...
    {
        string path = getRootPath + playableName + "/" + fileName + ".cs";
        using (StreamWriter writer = File.CreateText (path))
    ...
    string TrackAssetScript ()
    {
        return
            ...
            "[DisplayName(\"Idlez/" + playableName + " " + k_TrackAssetSuffix + "\")]\n" +
            TrackBindingToString() +
            "public class " + playableName + k_TrackAssetSuffix +
            (isSkillPlayable ? " : ZSkillTrackAsset<" : " : ZTrackAsset<") +
            playableName + k_PlayableBehaviourMixerSuffix +
            ">\n" +
            "{\n" +
            (isSkillPlayable ? "public override bool CanPlay(UnitSkin unit)\n\t{\n\t\treturn true;\n\t}\n" : "") +
            "}\n";
    }
    ...
    string PlayableAsset ()
    {
        return
            ...
            "\n" +
            "[Serializable]\n" +
            "public class " + playableName + k_TimelineClipAssetSuffix + " : ZClip<" + playableName + k_TimelineClipBehaviourSuffix + ">\n" +
            "{\n" +
            ExposedReferencesToString() +
            "\n" +
            k_Tab + "public override ClipCaps clipCaps => " + ClipCapsToString() + ";\n" +
            "\n" +
            "}\n";
    }
    ...
    string PlayableBehaviour ()
    {
        return
            ...
            "\n" +
            "[Serializable]\n" +
            "public class " + playableName + k_TimelineClipBehaviourSuffix + " : " + PlayableBehaviourBaseClass() + "\n" +
            "{\n" +
    ...
    string PlayableBehaviourBaseClass()
    {
        return isSkillPlayable ? "ZSkillPlayableBehaviour" : "ZPlayableBehaviour";
    }
    ...
    string PlayableBehaviourMixer ()
    {
        return 
            ...
            AdditionalNamespacesToString() +
            "\n" +
            "public class " + playableName + k_PlayableBehaviourMixerSuffix + " : " + PlayableBehaviourMixerBaseClass() + "\n" +
            "{\n" +
            ...
            k_Tab + k_Tab + "var inputCount = playable.GetInputCount ();\n" +
            "\n" +
            k_Tab + k_Tab + "for (var i = 0; i < inputCount; i++)\n" +
            k_Tab + k_Tab + "{\n" +
            k_Tab + k_Tab + k_Tab + "var inputWeight = playable.GetInputWeight(i);\n" +
            k_Tab + k_Tab + k_Tab + "var inputPlayable = (ScriptPlayable<" + playableName + k_TimelineClipBehaviourSuffix + ">)playable.GetInput(i);\n" +
            k_Tab + k_Tab + k_Tab + "var input = inputPlayable.GetBehaviour ();\n" +
            k_Tab + k_Tab + k_Tab + "\n" +
    ...
    string PlayableBehaviourMixerBaseClass()
    {
        return isSkillPlayable ? "ZSkillMixerBehaviour" : "ZMixerBehaviour";
    }
    ...
    string StandardBlendPlayableBehaviour ()
    {
        return
            ...
            "\n" +
            "[Serializable]\n" +
            "public class " + playableName + k_TimelineClipBehaviourSuffix + " : ZPlayableBehaviour\n" +
            "{\n" +
    ...
    string StandardBlendPlayableBehaviourMixer ()
    {
        return
            ...
            AdditionalNamespacesToString() +
            "\n" +
            "public class " + playableName + k_PlayableBehaviourMixerSuffix + " : ZMixerBehaviour\n" +
            "{\n" +
