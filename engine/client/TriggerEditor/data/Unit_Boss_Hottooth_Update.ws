{
  ...
  "metadata": {
    "name": "Unit_Boss_Hottooth_Update",
    "period": "15",
    "triggerType": "1"
  },
  "scroll": {},
  "variables": [
    ...
    {
      "id": "c#8W5?V}Ki({1{v620i9",
      "name": "Buff/IsInitVariables"
    },
    {
      "id": "+2s:yK-2Y*t31i8d{,i|",
      "name": "Buff/CurrentWave"
    },
    {
      "id": "%S5QD]GM1wR-To3`vBmI",
      "name": "@Map/AddBuffToMonsterID01"
    },
    {
      "id": "NL3)t^Pg_DzmoA*qp;!b",
      "name": "@Map/AddBuffToMonsterID02"
    },
    {
      "id": "%Ce+!t7XOaVA=p#uk2}I",
    ...
    {
      "id": "}9?Nb,ZDIEIOGmI95K^y",
      "name": "@Map/AddBuffToMonsterID05"
    },
    {
      "id": "WSAS3$6(7:rj2@u19~bl",
      "name": "@Map/AddBuffToBossID01"
    },
    {
      "id": "r2x?1Cxu|M~$~0g|-PaR",
      "name": "@Map/AddBuffToBossID02"
    },
    {
      "id": "q0m((qlldMo(r5I,{uUU",
      "name": "@Map/AddBuffToBossID03"
    },
    {
      "id": "//iWEEofbJoz3y!Me2xv",
    ...
    {
      "id": "^`oG{JCU:ylYTI(?x2In",
      "name": "@Map/NextMapDataId"
    },
    {
      "id": "L6CN;9CBzn5xv|Kd}VWw",
      "name": "@Map/Progress"
    },
    {
      "id": "t,E6CCWd*^[t!w9a!G$W",
      "name": "Map/Player/Moving"
    },
    {
      "id": "gxBPVqu_W62tXFbGLn06",
      "name": "Map/DisplayWinningTeam"
    },
    {
      "id": "qIm|qLPLtG(uI17~r%[x",
      "name": "@Buff/Variable/07"
    },
    {
      "id": "ay,Rf0PZwu0OmNs2m*mY",
    ...
    {
      "id": "3(+yYx)cmXltBMpQ!659",
      "name": "@Buff/Variable/10"
    },
    {
      "id": "cU}*ZX!5j]bEnzeV}TKH",
      "name": "@Skill/Variable/04"
    },
    {
      "id": "7r!DGu8Z)-$MDzdSF!S`",
      "name": "@Skill/Variable/05"
    },
    {
      "id": "L%ugbZ*?u.RgzSw!uI1O",
      "name": "@Skill/Variable/06"
    },
    {
      "id": "FG{{pP{RWPZ`O2:i(wsQ",
    ...
    {
      "id": "s+}WjNarOKc%wvzEi_1d",
      "name": "@Skill/Variable/09"
    },
    {
      "id": "2kU-HFI}oU$K~wRO5QdQ",
