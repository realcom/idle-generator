{
  ...
  "variables": [
    ...
    {
      "id": "4^(S$z[f9%7lDWjH^3pg",
      "name": "Buff/CurrentWave"
    },
    {
      "id": "S@9QLEX27;qfdn4`)x~]",
    ...
    {
      "id": "ZO}Hu63TR{;TX]$q]5uX",
      "name": "@Map/AddBuffToBossID05"
    },
    {
      "id": "/D=n?|D)1ahRqi]d((F0",
      "name": "@Unit/ChargeSkillID/01"
    },
    {
      "id": "D+=o2gx]X)BBl]|izY~A",
      "name": "@Map/NextMapDataId"
    },
    {
      "id": "Q?KCkE`Ud1;a`-P9Vg?(",
      "name": "@Map/Progress"
    },
    {
      "id": "p#ZhQz]b?kT|ELN@haT~",
      "name": "Map/Player/Moving"
    },
    {
      "id": "CFf,pZzH(T.kopFAd5+i",
      "name": "Map/DisplayWinningTeam"
    },
    {
      "id": "D@M9zG[BF-m]1_+9/~cW",
    ...
    {
      "id": "HlqRW#Eqf)TN-uz@Fl,r",
      "name": "@Buff/Variable/09"
    },
    {
      "id": "TcR+h6y$EwFGw:)U}#gv",
      "name": "@Buff/Variable/10"
    },
    {
      "id": "$t{g2F8#EK|d?^sXow~s",
    ...
    {
      "id": "vx(P@ggtU.t(P0/Daz/Y",
      "name": "@Skill/Variable/06"
    },
    {
      "id": "=2I#brg@Iso_|coppY$7",
      "name": "@Skill/Variable/07"
    },
    {
      "id": "=UT94|EWU8cKlL!Dl?q_",
      "name": "@Skill/Variable/08"
    },
    {
      "id": "_Q?oU(6kE/w_h]1-uafR",
      "name": "@Skill/Variable/09"
    },
    {
      "id": "Yx1bXMJnH-y#b,.1c5r{",
      "name": "@Skill/Variable/10"
    },
    {
      "id": "HnD#aB+a@2AN8Nh6k|DE",
      "name": "@Skill/Trait/ResetOnKill"
    },
    {
      "id": "7|uoRE@cDBApF|q/_l99",
    ...
    {
      "id": "k%JIWDT!Tf=~u(Bg?sh#",
      "name": "@Map/Player/InitBuff3"
    },
    {
      "id": "7F:Z07Bt~j^jc`a54rpt",
