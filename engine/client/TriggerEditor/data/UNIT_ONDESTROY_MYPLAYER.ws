{
  ...
  "variables": [
    ...
    {
      "id": "s^!{g8U7|H6(7J@Va::u",
      "name": "@Map/Variable02"
    },
    {
      "id": "0P})^rdrLEkgo}2XnCkY",
      "name": "@Map/Variable03"
    },
    {
      "id": "pcP[#%3+7*6kvsxRudVv",
      "name": "@Map/Variable04"
    },
    {
      "id": "4_nsc|SbS/1UDQLIgqh:",
      "name": "@Map/Variable05"
    },
    {
      "id": "c(MON#/Lm)mpr_ZT1P=[",
    ...
    {
      "id": "$9a/DxlgsLu2:)R1D,[P",
      "name": "@Map/WaveAchID02"
    },
    {
      "id": "d:C2ILDdt5b$H*noF0Ad",
      "name": "@Map/WaveAchID03"
    },
    {
      "id": "P,yYA=3`lPO3[@vvJyL0",
      "name": "@Map/WaveAchID04"
    },
    {
      "id": "WSeZdZQPT6,EhAnvcI`@",
    ...
    {
      "id": "hCP+kth$@4KEes?,Qb_J",
      "name": "@Map/WaveAchID07"
    },
    {
      "id": "Aw^r(:YXlGmB[,tdPh`C",
      "name": "@Map/WaveAchID08"
    },
    {
      "id": "D,ZSIPN`[s`B`kFSZp*Z",
      "name": "@Map/WaveAchID09"
    },
    {
      "id": "=H[@lQyaSx@5SX,EwWVq",
    ...
    {
      "id": "B9yY:QA{^LVtawVXIQ`9",
      "name": "@Buff/Variable/02"
    },
    {
      "id": "ENzJd}.uv#;4S0~OP:Rn",
      "name": "@Buff/Variable/03"
    },
    {
      "id": "o9#08*^:(tBcb81UPXnm",
      "name": "@Buff/Variable/04"
    },
    {
      "id": "BV!LzHJ6?fTu=xl_!vS/",
      "name": "@Buff/Variable/05"
    },
    {
      "id": "%wswcjb!f|s(C|[D_wa;",
      "name": "@Buff/Variable/06"
    },
    {
      "id": "$L0YPq+v;3DI;1?fQ_K~",
      "name": "@Unit/Type/Armor/Normal"
    },
    {
      "id": "(bLaAy9[@kID-PCo?a5M",
      "name": "@Unit/Type/Armor/Light"
    },
    {
      "id": "*_LCQrRcFT#6LDuVBh$g",
      "name": "@Unit/Type/Armor/Heavy"
    },
    {
      "id": "b~0flaG$o}jgo_~vNr6X",
      "name": "Skill/TIMELINE_DAMAGE_001"
    },
    {
      "id": "X(mr~Q#0Ipo*~moG7:6d",
      "name": "Skill/TIMELINE_DAMAGE_002"
    },
    {
      "id": "pj5P{Re7IHU=APeK^rC[",
      "name": "Skill/TIMELINE_DAMAGE_003"
    },
    {
      "id": "T`f=dIUkZW]0=7V9/(Ly",
    ...
    {
      "id": "?/aWfB(Mau3BHDSz8Vq0",
      "name": "Skill/TIMELINE_HEAL_002"
    },
    {
      "id": "+@B.nDG14@BLX*reCQ6L",
      "name": "Skill/TIMELINE_HEAL_003"
    },
    {
      "id": "Vdv5#[bnh;V.=e5JCVTc",
      "name": "Skill/TIMELINE_HEAL_004"
    },
    {
      "id": "lB!dY/yZ.zzo%VH:MeJm",
      "name": "@Skill/Variable/01"
    },
    {
      "id": "HsQjcP[y:_2-YUz/UeN7",
      "name": "@Skill/Variable/02"
    },
    {
      "id": "tO7Pj)U{ZBLUWwgOp[i|",
    ...
    {
      "id": "r1I;g6m9j9_q=@83WE@3",
      "name": "@MAP/WAVE3/MELEE_MONSTER2"
    },
    {
      "id": "mv4CCbDAS~!EDZf$E.-M",
      "name": "@MAP/WAVE3/MELEE_MONSTER3"
    },
    {
      "id": "4r)#]t[2fv]XbYN1j,+6",
    ...
    {
      "id": "Gb%eJ-bzcm[EA3Uo-C_;",
      "name": "@MAP/WAVE4/MELEE_MONSTER1"
    },
    {
      "id": "8K}vymFmhLZiSZ$bB+o_",
    ...
    {
      "id": "(Qq](uU*kTedO@s4!k5$",
      "name": "@MAP/WAVE4/RANGE_MONSTER1"
    },
    {
      "id": "Z4TW5)(NFm#7C;[wEop|",
      "name": "@MAP/WAVE4/RANGE_MONSTER2"
    },
    {
      "id": "V%Rn)M7.HS_n7_KBv_ns",
    ...
    {
      "id": "[lazUu}J7PA;+;Lx*a[h",
      "name": "@MAP/WAVE3/BOSS_MONSTER3"
    },
    {
      "id": "8Hr+fityIrXY|!1cb.oG",
      "name": "@MAP/WAVE3/BOSS_MONSTER4"
    },
    {
      "id": "C`[)}Lx5.GV5BTKpWR9W",
      "name": "@MAP/WAVE3/BOSS_MONSTER5"
    },
    {
      "id": "TZ_dtf5Qm[=O;W/yCDiM",
      "name": "@MAP/WAVE4/BOSS_MONSTER1"
    },
    {
      "id": "!lcv%qGCA[Hu9O;)s~e`",
      "name": "@MAP/WAVE4/BOSS_MONSTER2"
    },
    {
      "id": "vX1ll:7x3$E7`233P.Gy",
      "name": "@MAP/WAVE4/BOSS_MONSTER3"
    },
    {
      "id": "^jK*L!efwh$d;Z8}v3k:",
      "name": "@MAP/WAVE4/BOSS_MONSTER4"
    },
    {
      "id": "~r_W|4138?S~yT(M=$zG",
      "name": "@MAP/WAVE4/BOSS_MONSTER5"
    },
    {
      "id": "l{bB1i2|hiKYZDR/wSZO",
      "name": "Gem shops"
    },
    {
      "id": "-T#Z-l]h|VY1;CghAv6`",
      "name": "@Unit/Variable01"
    },
    {
      "id": "y|Q$URf`-Vh:ruFU.DqI",
      "name": "@Unit/Variable02"
    },
    {
      "id": "}Un4i+dr@FS[znxMn-^v",
      "name": "@Unit/Variable03"
    },
    {
      "id": "c_f5iXxO=o5{p9_+jRq=",
      "name": "@Unit/Variable04"
    },
    {
      "id": "M-ew:|k;gPKVu}2$=oY0",
    ...
    {
      "id": "N+^Y1JRuVDSZ?cs32U2~",
      "name": "@Map/Encounter/LevelUpTraitCount"
    },
    {
      "id": "=.P*364tn@:ek8#NLh]B",
    ...
    {
      "id": "vAm5-qUWdP5!pH3Jf1|$",
      "name": "Map/Wave/Step/Tick"
    },
    {
      "id": "[$O/`34SqD/niRtpf*Bv",
    ...
    {
      "id": "T7]^ubG%-Bb=V7}UnsM1",
      "name": "@Map/Wave1/Monster2"
    },
    {
      "id": "5}Ri0gpM7E^M{1*U::jj",
      "name": "@Map/Wave1/Monster3"
    },
    {
      "id": "ZnenaNT%Nw6e9=emM$qQ",
      "name": "@Map/Wave1/Monster4"
    },
    {
      "id": "uF4TD?f%)AF]5k{,-JkG",
      "name": "@Map/Wave1/Monster5"
    },
    {
      "id": "{HYW8lbUxeotVocx1I^8",
      "name": "@Map/Wave1/Monster6"
    },
    {
      "id": "x-8|jlY/:DYF96v/6I4i",
      "name": "@Map/Wave1/Monster7"
    },
    {
      "id": "R@Mq4e~tAv,lX#8#*?@b",
      "name": "@Map/Wave1/Monster8"
    },
    {
      "id": ".%RM/Ia8vL7l]mIK$Z0m",
      "name": "@Map/Wave1/Monster9"
    },
    {
      "id": "#6S}hjD`HWH_t.mCUM#r",
      "name": "@Map/Wave1/Monster10"
    },
    {
      "id": "T.Lkj]Mio8EPmA}r{6Ng",
      "name": "@Map/Wave2/Monster1"
    },
    {
      "id": ";zAqOz#JBY7X8$o%rUT(",
      "name": "@Map/Wave2/Monster2"
    },
    {
      "id": "8TL*W*ayk*t9AQGi]h%O",
      "name": "@Map/Wave2/Monster3"
    },
    {
      "id": "sVW.CG1Iu3[M[JyP9:52",
      "name": "@Map/Wave2/Monster4"
    },
    {
      "id": "^Cm+/XXA3rwt{B8c/E]c",
      "name": "@Map/Wave2/Monster5"
    },
    {
      "id": "^O0qJDfeBU+oY}cybk,f",
      "name": "@Map/Wave2/Monster6"
    },
    {
      "id": "6x/YGwc1b@T]-g`bU`tt",
      "name": "@Map/Wave2/Monster7"
    },
    {
      "id": "M}Q1FKctlO:0^2Oa`yV;",
      "name": "@Map/Wave2/Monster8"
    },
    {
      "id": "vOi,nOxw}nd*?c*y*;c!",
      "name": "@Map/Wave2/Monster9"
    },
    {
      "id": "-5y9CM`U8aR|5Z4C2d!K",
      "name": "@Map/Wave2/Monster10"
    },
    {
      "id": "NLpQ1.k;Pepnv~u4:c56",
    ...
    {
      "id": "T,r1fkLEt[i6Riy4oAmV",
      "name": "@Map/Wave3/Monster5"
    },
    {
      "id": "]AnvA%G#W$|/57zG%r1G",
      "name": "@Map/Wave3/Monster6"
    },
    {
      "id": "IeA2Lf.YEP^$d}VuNP16",
    ...
    {
      "id": "7R4=IxD,6K-r50}9.wa@",
      "name": "@Map/Wave3/Monster9"
    },
    {
      "id": "eZZ7ZLZdw5V`w]ZC3kjk",
      "name": "@Map/Wave3/Monster10"
    },
    {
      "id": "n]LnTgc{ulc,kN5E@F}b",
      "name": "@Map/Wave4/Monster1"
    },
    {
      "id": "w@KJ,N:6TwzH)0pQW*qt",
      "name": "@Map/Wave4/Monster2"
    },
    {
      "id": "DwqAxTD)2HF]n71jmMi9",
    ...
    {
      "id": "gT-yG8VG:C;L];Jww[2n",
      "name": "@Map/Wave4/Monster5"
    },
    {
      "id": "*JHlXHMoF.{XdF6W.G_=",
    ...
    {
      "id": "Ogv%R?42t`5a|-0Tewh^",
      "name": "@Map/Wave4/Monster8"
    },
    {
      "id": "t,C}F%XLQL57AwBzKm[2",
      "name": "@Map/Wave4/Monster9"
    },
    {
      "id": "}0l1]BitV|3.nh!+j@+r",
      "name": "@Map/Wave4/Monster10"
    },
    {
      "id": "`1B_Itx%Neb.lbHu|+%D",
      "name": "@Map/Wave5/Monster1"
    },
    {
      "id": "@Z9j4@=y0NFa$u,iDJGL",
    ...
    {
      "id": "vLL4e#37JZeCTZlKNWGt",
      "name": "@Map/Wave5/Monster4"
    },
    {
      "id": "$tw%cw`nP=#oB`S`]UYT",
      "name": "@Map/Wave5/Monster5"
    },
    {
      "id": "9j%{DNvqz%jbM+j7M/`K",
      "name": "@Map/Wave5/Monster6"
    },
    {
      "id": "Fax*v?3DZl?h`^XonIB9",
    ...
    {
      "id": "2,g4uEsVNS`Vt{C=Wk95",
      "name": "@Map/Wave5/Monster9"
    },
    {
      "id": "%ZjNlg,rVk0jOy6olxSW",
      "name": "@Map/Wave5/Monster10"
    },
    {
      "id": "2nrWT,x)E~QJ{vv|^$ys",
      "name": "Buff/IsInitVariables"
    },
    {
      "id": "$URL.U?L3ec-^CjV3PHJ",
      "name": "Buff/CurrentWave"
    },
    {
      "id": "%(8rp+/wCmsa_0hQm^Fd",
      "name": "@Map/AddBuffToMonsterID01"
    },
    {
      "id": "$DHexm=W9@zn1Te-1{]U",
      "name": "@Map/AddBuffToMonsterID02"
    },
    {
      "id": "G0^jyGa$dbvQw=4-,m[e",
      "name": "@Map/AddBuffToMonsterID03"
    },
    {
      "id": "N;T1lJ.)av95?N%z_q-n",
      "name": "@Map/AddBuffToMonsterID04"
    },
    {
      "id": "0Hb{;K4_PbnXNA=y%A0g",
      "name": "@Map/AddBuffToMonsterID05"
    },
    {
      "id": "Ea@QwVi~Vc(G/o:J)p9I",
      "name": "@Map/AddBuffToBossID01"
    },
    {
      "id": "]A(a`+W/wCl=HY^BRa}2",
      "name": "@Map/AddBuffToBossID02"
    },
    {
      "id": "dG}Y3hp0B-B;lK3XM:fE",
      "name": "@Map/AddBuffToBossID03"
    },
    {
      "id": "y5Bfbd!6m556.DgzY*RL",
      "name": "@Map/AddBuffToBossID04"
    },
    {
      "id": "fC8[5?SWRiRLi6e3aI:Z",
    ...
    {
      "id": "{u/oVZjXL%p;,fe(s{M5",
      "name": "@Buff/Variable/07"
    },
    {
      "id": "|~T`Isyf4C}lad1aZ4@H",
      "name": "@Buff/Variable/08"
    },
    {
      "id": "Y}#,me78p9+W{Uo2e%88",
      "name": "@Buff/Variable/09"
    },
    {
      "id": "A2?2Tebn0^vGjL3mJd[@",
    ...
    {
      "id": "y(Xuw@V$rli|snf8tSMW",
      "name": "@Skill/Variable/05"
    },
    {
      "id": "EVq|zwr5-1ydO%UkE*%q",
    ...
    {
      "id": "koWMB^WU2S7ItNp4c8]4",
      "name": "@Skill/Variable/08"
    },
    {
      "id": "9Rl/r-n|QGe(!|szxlXd",
      "name": "@Skill/Variable/09"
    },
    {
      "id": "MiWv3yR(UUT;G?T(d]AB",
    ...
    {
      "id": "VE{BSTIn:5TW8_S1_*(J",
      "name": "@Map/Player/InitBuff1"
    },
    {
      "id": "i}m94i{iiOQU~*zQ,Xig",
      "name": "@Map/Player/InitBuff2"
    },
    {
      "id": "CEvflS/WtP=+#lX44jK~",
    ...
    {
      "id": "LO2,gL[h;3_BcT?wf}K~",
      "name": "@Map/Player/InitUseSkill2"
    },
    {
      "id": "{odW}r|IMOELZ=o2y~jv",
      "name": "@Map/Player/InitUseSkill3"
    },
    {
      "id": "p=J:KI.PWJ}HNDb|@b.q",
