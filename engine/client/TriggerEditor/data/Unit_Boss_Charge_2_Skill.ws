{
  ...
  "variables": [
    ...
    {
      "id": "Lp0gC?;^rkN_Gdf}+hQz",
      "name": "Buff/IsInitVariables"
    },
    {
      "id": "J!Rwe]oEx~NJtIvS6aOF",
      "name": "Buff/CurrentWave"
    },
    {
      "id": "A)AyXk?7v$pTEy#ygO{k",
      "name": "@Map/AddBuffToMonsterID01"
    },
    {
      "id": "gUeBr}1,3!9hZ_Ml]K3;",
    ...
    {
      "id": "0ga6U):9:gv/Obto2Un,",
      "name": "@Map/AddBuffToMonsterID04"
    },
    {
      "id": "z3^q;JZp;EfUJ4fH`yvx",
      "name": "@Map/AddBuffToMonsterID05"
    },
    {
      "id": "^PcCw@*r#x4rOXJg;WHV",
      "name": "@Map/AddBuffToBossID01"
    },
    {
      "id": "2H6jQx]WoNcQr;u]R`59",
      "name": "@Map/AddBuffToBossID02"
    },
    {
      "id": "W+f7ac/tJde##XLmAfQN",
    ...
    {
      "id": "vw#%AFv*qXv{!I@zDpeF",
      "name": "@Map/AddBuffToBossID05"
    },
    {
      "id": "8~iXHA*uu[gyHr|rwc5t",
      "name": "@Map/NextMapDataId"
    },
    {
      "id": "MKQoKLPOEKHhDsnn[o#Z",
      "name": "@Map/Progress"
    },
    {
      "id": "P?%weF77IUe]-[CDf{Gs",
      "name": "Map/DisplayWinningTeam"
    },
    {
      "id": ":f0uRWTXO`OM)A|($h/f",
    ...
    {
      "id": "Mcs%)H+Z;BL=_ei*ME,R",
      "name": "@Skill/Variable/06"
    },
    {
      "id": "JgNO{88fE/eZ{Kc`l[;j",
      "name": "@Skill/Variable/07"
    },
    {
      "id": "yX{,i6bgw|=.U7z.f`On",
      "name": "@Skill/Variable/08"
    },
    {
      "id": "@scUJu)gsEGgvGAg~lTs",
      "name": "@Skill/Variable/09"
    },
    {
      "id": "48T$xcUv;qaBa]WvMmat",
