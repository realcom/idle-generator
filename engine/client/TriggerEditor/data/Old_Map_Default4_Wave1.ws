                ...
                "inputs": {
                  ...
                  "IF0": {
                    "block": {
                      ...
                      "id": "Q=3.6#l0[q5[d=/HolLd",
                      "inputs": {
                        "A": {
                          "block": {
                            "id": "ek;_:3D/Z.g,Vp`i;{SA",
                            "inputs": {
                              "DIVIDEND": {
                                "block": {
                                  "fields": {
                            ...
                            "inputs": {
                              ...
                              "IF0": {
                                "block": {
                                  ...
                                  "id": "l/1mX5.y*1y_E+n2p8$x",
                                  "inputs": {
                                    "A": {
                                      "block": {
                                        "id": "d2Cd:^%M5S[Y9YVJt*e.",
                                        "inputs": {
                                          "DIVIDEND": {
                                            "block": {
                                              "fields": {
                                ...
                                "inputs": {
                                  ...
                                  "IF0": {
                                    "block": {
                                      ...
                                      "id": ".KnlDzbJn%on3DhkY?pa",
                                      "inputs": {
                                        "A": {
                                          "block": {
                                            "id": "9~yD=v8#mD6RG?GriuvU",
                                            "inputs": {
                                              "DIVIDEND": {
                                                "block": {
                                                  "fields": {
