{
  ...
  "variables": [
    ...
    {
      "id": "!L8NhAXfawZ_f9)!StqS",
      "name": "@Map/AddBuffToBossID05"
    },
    {
      "id": "UMl%IwlIkxLlgZt:J85y",
      "name": "@Map/NextMapDataId"
    },
    {
      "id": "5Ck_84O)rXBklB7K|Hy!",
      "name": "@Map/Progress"
    },
    {
      "id": "^45kFr]1a2K]TAq)iQ$f",
      "name": "@Skill/Variable/04"
    },
    {
      "id": "B}^:jdn?,0p)r%G0*zaU",
      "name": "@Skill/Variable/05"
    },
    {
      "id": "$_T_`_p7+$*YCp;OtGME",
      "name": "@Skill/Variable/06"
    },
    {
      "id": "*F0j|JYNB-tA%ug%)p=B",
      "name": "@Skill/Variable/07"
    },
    {
      "id": "$v:zH?emv|J-zjVFGm^w",
