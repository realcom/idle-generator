{
                ...
                "block": {
                  ...
                  "next": {
                    "block": {
                      ...
                      "next": {
                        "block": {
                          "id": "wSOYQ!Up;@S~LBv|0N#{",
                          "inputs": {
                            "DO0": {
                              "block": {
                                "id": "ko/H]i4UIj;+?c=Qezb7",
                                "inputs": {
                                  "DO0": {
                                    "block": {
                                      "id": "**7^[+8?-zE0IR$,RGwm",
  ...
  "variables": [
    ...
    {
      "id": "Uj{6Q6#0GWNi3GFpoSFO",
      "name": "Buff/IsInitVariables"
    },
    {
      "id": "+n:y%=^Y%au#kL!Wt!y3",
      "name": "Buff/CurrentWave"
    },
    {
      "id": "O;l/}pWC)wAn]Dr#_+Xa",
