{
  "blocks": {
    "blocks": [
      ...
      {
        "id": "]+sF6eCm_-WV;^15YMzx",
        "inputs": {
          "DO0": {
            "block": {
              "id": "xZvlP-T-r]omI4V3s!Wf",
              "inputs": {
                "DO": {
                  "block": {
                    "id": ";pAM5byRT``^*T}:dD8#",
  ...
  "metadata": {
    "name": "Buff_UseSkillOnSpawnWeapon_Update",
    "period": "15",
    "triggerType": "1"
  },
  "scroll": {},
