{
  "blocks": {
    "blocks": [
      {
        "fields": {
          "TEXT": "피해를 받은 후 다음 공격의 공격력 45%(3315041)"
        },
        "id": "E6z5[88/4Ip_.99Njbr!",
        "type": "text",
        "x": -105,
        "y": -15
      },
      ...
      {
        "fields": {
          "TEXT": "보스에게 피해를 받을 시 공격력 +8% (최대 64%)(3215011)"
        },
        "id": "d9tOk+r72p`,0:*_P^c~",
        "type": "text",
        "x": -125,
        "y": 335
      },
      {
        "id": "n;N+Dl1wNEqh@wUm;1xS",
        "inputs": {
          "DO0": {
            "block": {
              "extraState": "<mutation itemCount=\"2\" metadata=\"[{&quot;comment&quot;:&quot;Buff Data Id (필수)&quot;,&quot;name&quot;:&quot;BuffDataId&quot;},{&quot;comment&quot;:&quot;slot유닛 여부(1=slot)&quot;,&quot;name&quot;:&quot;Value&quot;}]\"></mutation>",
      ...
      {
        "fields": {
          "TEXT": "\"전투 중 보스에게 8번 피해를 받을 시 ..3216011"
        },
        "id": "/i;Z+2CWWm%s3Nc]Sb9]",
        "type": "text",
        "x": -145,
        "y": 675
      },
      {
        "fields": {
          "TEXT": "피해를 받은 후 다음 공격의 치명타 확률 +25%(3115041)"
        },
        "id": "C0WbZ/AQOWuCIY+TCliv",
        "type": "text",
        "x": -105,
        "y": -285
      },
      {
        "id": "a(a/xhHnJ::fElOf$OSz",
        "inputs": {
          "DO0": {
            "block": {
              "extraState": "<mutation itemCount=\"2\" metadata=\"[{&quot;comment&quot;:&quot;Buff Data Id (필수)&quot;,&quot;name&quot;:&quot;BuffDataId&quot;},{&quot;comment&quot;:&quot;slot유닛 여부(1=slot)&quot;,&quot;name&quot;:&quot;Value&quot;}]\"></mutation>",
  ...
  "variables": [
    ...
    {
      "id": "LEu@rfnzaYGO1wg-o5?3",
      "name": "@Map/AddBuffToMonsterID01"
    },
    {
      "id": "24~bmj?kM_?[iS_1a*TM",
    ...
    {
      "id": "44590Eo55JZsxAT{?3`j",
      "name": "@Map/AddBuffToMonsterID05"
    },
    {
      "id": "057ijG$w[$jz.Bb(qjDD",
      "name": "@Map/AddBuffToBossID01"
    },
    {
      "id": "Y.fYabd.vhnMO|~bm!s*",
      "name": "@Map/AddBuffToBossID02"
    },
    {
      "id": "-##4}Sw9Ydbt`l$Az8Cy",
      "name": "@Map/AddBuffToBossID03"
    },
    {
      "id": "Q{!3IDTT!lRXX+~:wH)4",
      "name": "@Map/AddBuffToBossID04"
    },
    {
      "id": "Z`NWnvaTxG[%}A8W@n$2",
      "name": "@Map/AddBuffToBossID05"
    },
    {
      "id": "O,llfyA;@?3-fPSsb?tN",
      "name": "@Map/NextMapDataId"
    },
    {
      "id": "cwqt7,EX,e7FC]u=e,@E",
      "name": "@Map/Progress"
    },
    {
      "id": "5e6c;tPiMc.#q+|UU9Kr",
      "name": "@Skill/Variable/04"
    },
    {
      "id": "p;SVIxrx#.5G_MUCw/lw",
      "name": "@Skill/Variable/05"
    },
    {
      "id": "NkB9Ln?M7NjuH-)dIL(J",
    ...
    {
      "id": "h=am6Vz?q4j}BH%zAQaQ",
      "name": "@Skill/Variable/08"
    },
    {
      "id": "0claFyLB+:+g3IW5#QHd",
      "name": "@Skill/Variable/09"
    },
    {
      "id": "1lc;rK{m?yi,B_Ye08KQ",
      "name": "@Skill/Variable/10"
    },
    {
      "id": "b30Y9Wb!_fXBFYlCw+Hs",
