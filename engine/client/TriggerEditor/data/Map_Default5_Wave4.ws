{
                                                          ...
                                                          "inputs": {
                                                            ...
                                                            "IF0": {
                                                              "block": {
                                                                ...
                                                                "id": "czC^=N_kV;N/+U,PQJHZ",
                                                                "inputs": {
                                                                  "A": {
                                                                    "block": {
                                                                      "id": "F0up^lPaOaxfy~]V:ErP",
                                                                      "inputs": {
                                                                        "DIVIDEND": {
                                                                          "block": {
                                                                            "fields": {
  ...
  "variables": [
    ...
    {
      "id": "bTf9@.YsY%j$x6;LtWfL",
      "name": "Buff/CurrentWave"
    },
    {
      "id": "f/ZYy(RgN8r]|xH?b=rG",
      "name": "@Map/AddBuffToMonsterID01"
    },
    {
      "id": "tG)OHJf$yB}%~73ZN8}V",
      "name": "@Map/AddBuffToMonsterID02"
    },
    {
      "id": "a7W69=@fP:C=,45mn}bm",
      "name": "@Map/AddBuffToMonsterID03"
    },
    {
      "id": "%O]N:IhfIynO/22?g402",
    ...
    {
      "id": "z7$^g-L4]QXpsEVW}(OO",
      "name": "@Skill/Variable/04"
    },
    {
      "id": "44{m/94}z`x~dz{t{M|R",
    ...
    {
      "id": "s8Z9+GiC6Ojhrwk8~:-M",
      "name": "@Skill/Variable/09"
    },
    {
      "id": "wW(@W)EP(H/|rUeY@e95",
