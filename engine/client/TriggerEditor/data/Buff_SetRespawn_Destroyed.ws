{
  "blocks": {
    "blocks": [
      {
        "id": "0k.6q4x+Q3Fy0+huPEg+",
        "inputs": {
          "DO0": {
            "block": {
              "fields": {
                "THIS": true,
                "VAR": "unitVariable:RespawnHpPercent"
              },
              "id": "o!((`2gDV=6[R.@H-_`O",
              "inputs": {
                "VALUE": {
              ...
              "next": {
                "block": {
                  "fields": {
                    "THIS": true,
                    "VAR": "unitVariable:RespawnMpPercent"
                  },
                  "id": "h~uJO6YGvvIW#$KUEB+L",
                  "inputs": {
                    "VALUE": {
                      "block": {
                        "extraState": "<mutation></mutation>",
                  ...
                  "next": {
                    "block": {
                      "extraState": "<mutation itemCount=\"1\" metadata=\"[{&quot;comment&quot;:&quot;Respawn delay(default = 1)&quot;,&quot;name&quot;:&quot;Duration&quot;}]\"></mutation>",
                      "fields": {
                        "NAME": "unitMethod:SetRespawnDelay",
                        "THIS": true
                      },
                      "id": "o_^Dj06(2Dnu/O4b-W,e",
                      "inputs": {
                        "ARG0": {
                          "block": {
                            "extraState": "<mutation></mutation>",
  ...
  "metadata": {
    "name": "Buff_SetRespawn_Destroyed",
    "period": "0",
    "triggerType": "5"
  },
  "scroll": {},
