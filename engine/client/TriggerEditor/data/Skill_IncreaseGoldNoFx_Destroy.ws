{
  "blocks": {
    "blocks": [
      {
        "extraState": "<mutation itemCount=\"1\" metadata=\"[{&quot;comment&quot;:&quot;Gold Cout&quot;,&quot;name&quot;:&quot;Count&quot;}]\"></mutation>",
        "fields": {
          "NAME": "unitMethod:IncreaseGold",
          "THIS": true
        },
        "id": "8++)e~;^L3D#X(f:SKVs",
        "inputs": {
  ...
  "metadata": {
    "name": "Skill_IncreaseGoldNoFx_Destroy",
    "period": "30",
    "triggerType": "5"
  },
  "scroll": {},
  "variables": [
    ...
    {
      "id": "*E1`p%V-^S7kY3Q{-qd3",
      "name": "@MAP/WAVE1/MELEE_MONSTER4"
    },
    {
      "id": "uwqc.o]c8Az!E{tJYF3v",
      "name": "@MAP/WAVE1/MELEE_MONSTER5"
    },
    {
      "id": "xH`k{IG`,^FmBWTrxes[",
    ...
    {
      "id": "UkdzdpR,|N+p1:Kfey}y",
      "name": "@MAP/WAVE2/RANGE_MONSTER4"
    },
    {
      "id": "J5XC1f,fM@Q?,I@ogdod",
      "name": "@MAP/WAVE2/RANGE_MONSTER5"
    },
    {
      "id": "tqRnVOi=Rn{;y6(nsg:F",
    ...
    {
      "id": ".G?WyU]MdV{nkD1u6DsZ",
      "name": "@MAP/WAVE3/RANGE_MONSTER3"
    },
    {
      "id": "MHyvIsHqb-bG-:Ve/,G!",
    ...
    {
      "id": "npWS!oa0WHc,sp;@6|9K",
      "name": "@MAP/WAVE4/RANGE_MONSTER1"
    },
    {
      "id": "Q?(BTY^5)-O,FsUuJ+8,",
      "name": "@MAP/WAVE4/RANGE_MONSTER2"
    },
    {
      "id": "N[R7-90:W17c,/oj(3Jt",
    ...
    {
      "id": "P,e;KF^ka}Aqe~9Xy)):",
      "name": "@MAP/WAVE3/TANKER_MONSTER5"
    },
    {
      "id": "i{-m{|Y$lu##U2m-FxRS",
      "name": "@MAP/WAVE4/TANKER_MONSTER1"
    },
    {
      "id": "A9uwTCQv7YQBac/:NyVx",
    ...
    {
      "id": "r96K^*XSIHI@US*)@PLb",
      "name": "@MAP/WAVE3/BOSS_MONSTER4"
    },
    {
      "id": "a%ZTTFOK{p(1}zoB7?hp",
    ...
    {
      "id": "z5_4@60C1ak.IIH*(TQu",
      "name": "@MAP/WAVE4/BOSS_MONSTER2"
    },
    {
      "id": "GNFW~mFlaios7px)4;n0",
    ...
    {
      "id": "wu[O]H[:em7-(EJ9)wdf",
      "name": "@MAP/WAVE4/BOSS_MONSTER5"
    },
    {
      "id": "Tobl6$ok5Q(=k_DlihJL",
      "name": "@Unit/Variable01"
    },
    {
      "id": "F@m9;pM^FeKMX?z[F2b%",
      "name": "@Unit/Variable02"
    },
    {
      "id": "`Narx0UI+QZ_hWt1K!t*",
      "name": "@Unit/Variable03"
    },
    {
      "id": "op^!/8m;wW3SCV$|89Q3",
      "name": "@Unit/Variable04"
    },
    {
      "id": "!o[d_Yl,#xXzsu(py)V4",
      "name": "@Unit/Variable05"
    },
    {
      "id": "Y1qK)ZdbEw-A~mPS@B,z",
      "name": "@Map/Encounter/Step"
    },
    {
      "id": "n`J_E-l(`2gIzra(fb]w",
      "name": "@Map/Encounter/LevelUpTraitCount"
    },
    {
      "id": "~2HC`xV3o~tYnbILqYOB",
      "name": "@Map/Encounter/WaveEndTraitCount"
    },
    {
      "id": "MeVeR5}d7|%.UDO$b~1Z",
      "name": "@Skill/Trait/BlastIncreaseKBPercent"
    },
    {
      "id": "K~o{9*@H~tF;j(JE$-z8",
      "name": "Gem shops"
    },
    {
      "id": "S}B^l7tCQ=Vq,`1AWu1I",
    ...
    {
      "id": "hxzmA1oe7RzA%I0}1NM[",
      "name": "@Map/WaveAchID00"
    },
    {
      "id": "^?G%js^Zu@Jq_`ALt%-y",
      "name": "Map/Wave"
    },
    {
      "id": "pAN1dsu~TOMao8}#,fx,",
      "name": "Map/Wave/StringId"
    },
    {
      "id": "SiSJDELNqU)R7O5JZ*vu",
      "name": "Map/Wave/Step"
    },
    {
      "id": "Kb/5$T56to^zlV-1cr-l",
      "name": "Map/Wave/Step/Tick"
    },
    {
      "id": "7~uRYxEwpbZa~A9Q2m?:",
      "name": "Map/Wave/StartTick"
    },
    {
      "id": "brK44D{/M,4-P^Et~8X+",
      "name": "Map/Wave/EndTick"
    },
    {
      "id": "Z)0uo^P?cT85rPtm_1ll",
      "name": "Map/Wave/State"
    },
    {
      "id": "5+k!Nh5mBx1Mq8Ij7RG9",
      "name": "@Skill/Trait/Feast"
    },
    {
      "id": "h@xyzOmVhk+|^-lCC%EC",
      "name": "@Map/Wave1/Monster1"
    },
    {
      "id": "C!9nLAZpkQ(m}9gm;*nR",
    ...
    {
      "id": "^ZwDZGTdAu=PAV[4]Znd",
      "name": "@Map/Wave2/Monster2"
    },
    {
      "id": "j?Re@*vsk(}U:ErL[Q6S",
      "name": "@Map/Wave2/Monster3"
    },
    {
      "id": "4mTwp3~$0,K)fu5^ZqhR",
    ...
    {
      "id": "Z)Hy+^2I@.iS(pLKjq!2",
      "name": "@Map/Wave2/Monster6"
    },
    {
      "id": "#)pI;q.*Ogd$c]A?vvvp",
      "name": "@Map/Wave2/Monster7"
    },
    {
      "id": "v+n,Z3UfC4eq`iH`(^MI",
      "name": "@Map/Wave2/Monster8"
    },
    {
      "id": "{b!]1vd7D!6j9wpF^H4m",
      "name": "@Map/Wave2/Monster9"
    },
    {
      "id": "t?OYB8qme{$^pMV@bmJg",
      "name": "@Map/Wave2/Monster10"
    },
    {
      "id": "%Tss$7#uu$oN6)iM7u%c",
    ...
    {
      "id": "ZKj/ZWA~?VnZmkYEW%Z1",
      "name": "@Map/Wave3/Monster3"
    },
    {
      "id": "L~j2aP$x;1iQMZ^/2M4A",
      "name": "@Map/Wave3/Monster4"
    },
    {
      "id": "3_#{B!@_Ypyn:X4T9{m[",
    ...
    {
      "id": "haqyAn@39bIfTty/k)@F",
      "name": "@Map/Wave3/Monster7"
    },
    {
      "id": "5NF@rzSB#*g[0SGBr33G",
    ...
    {
      "id": "LxaKnw_G#n7YIK(-WH{E",
      "name": "@Map/Wave3/Monster10"
    },
    {
      "id": "f;^!6NR|HHZ9.k2XLkt,",
      "name": "@Map/Wave4/Monster1"
    },
    {
      "id": "raZ@A:+j,2}qqUcf%5Yl",
    ...
    {
      "id": "924z(AhXC_utlv`zSa6F",
      "name": "@Map/Wave4/Monster4"
    },
    {
      "id": "G.9[FZ?|6!aCsJ:5Fs-c",
    ...
    {
      "id": "A(vVmpwm1+=eJLp-}]Q8",
      "name": "@Map/Wave4/Monster7"
    },
    {
      "id": "YPz1)(|(1b?k|d6Ymt,J",
      "name": "@Map/Wave4/Monster8"
    },
    {
      "id": "5`fL=:09uh`IQ:7/YX.(",
      "name": "@Map/Wave4/Monster9"
    },
    {
      "id": "m6;a2[PIW:^:YU5WS^b}",
      "name": "@Map/Wave4/Monster10"
    },
    {
      "id": "bR!+GpV(.Fb9xgxmO!%b",
      "name": "@Map/Wave5/Monster1"
    },
    {
      "id": "5HSjT1w/Q6}kT.cisFZQ",
      "name": "@Map/Wave5/Monster2"
    },
    {
      "id": "Z4y_nq^?AM09eFG?EP1r",
      "name": "@Map/Wave5/Monster3"
    },
    {
      "id": "](fm}CsF4EWNI+D2e#gE",
      "name": "@Map/Wave5/Monster4"
    },
    {
      "id": "6PvlJ#*)5PtXtQ=AR-Vn",
      "name": "@Map/Wave5/Monster5"
    },
    {
      "id": "6}sSozKG_nkOU=MMN(pC",
      "name": "@Map/Wave5/Monster6"
    },
    {
      "id": "#e^XjHa-`S-3WbJ36mcg",
      "name": "@Map/Wave5/Monster7"
    },
    {
      "id": "`Uyz^@RpG@uU:WA.Efa7",
      "name": "@Map/Wave5/Monster8"
    },
    {
      "id": "!aS)^zIam5~eQqSSnq7Z",
      "name": "@Map/Wave5/Monster9"
    },
    {
      "id": ";1[$]VXfoc:a7_NqM61Q",
      "name": "@Map/Wave5/Monster10"
    },
    {
      "id": "MYWjpPk7e^iVXUnQRAzM",
      "name": "Gem"
    },
    {
      "id": "eK!J/f~3W*~G--O@L~]U",
      "name": "Buff/IsInitVariables"
    },
    {
      "id": ",gsuh4}9G}ld?`Hq@NzE",
      "name": "Buff/CurrentWave"
    },
    {
      "id": "4HczS|:8xwk4%h:]4@J,",
      "name": "@Map/AddBuffToMonsterID01"
    },
    {
      "id": "U~q}D`a#t$R8FU:ro6Ox",
      "name": "@Map/AddBuffToMonsterID02"
    },
    {
      "id": "d39fH5Q34kx=EAfjT5nq",
      "name": "@Map/AddBuffToMonsterID03"
    },
    {
      "id": "Z4c?K~#$_H@gdEl,h)_}",
    ...
    {
      "id": "e%b+X;WZ1_VQAYN3z;[0",
      "name": "@Map/AddBuffToBossID01"
    },
    {
      "id": "HrLzyv_c0HE]~n0!2K4$",
      "name": "@Map/AddBuffToBossID02"
    },
    {
      "id": "X=4`3fD(fNt.K++SejGw",
      "name": "@Map/AddBuffToBossID03"
    },
    {
      "id": "k:}UFYk-%rQN-W{k#/kM",
      "name": "@Map/AddBuffToBossID04"
    },
    {
      "id": "UuI,s[mMmCc?B[H%/60;",
      "name": "@Map/AddBuffToBossID05"
    },
    {
      "id": "1RuS]dPllNq7J9+I,QIe",
      "name": "@Unit/ChargeSkillID/01"
    },
    {
      "id": "}YSulj{7+jI0B*%Dmj9X",
      "name": "@Map/NextMapDataId"
    },
    {
      "id": "BawQwGF!7Ucf`[^C^exd",
      "name": "@Map/Progress"
    },
    {
      "id": "Q-tm-`VrN+P*h{l=1Cp]",
      "name": "Map/Player/Moving"
    },
    {
      "id": "Xnqy:!bt8]sq8k2j^so,",
      "name": "@Buff/Variable/07"
    },
    {
      "id": "H}2#P)G:Rd+p|$}*mq=g",
      "name": "@Buff/Variable/08"
    },
    {
      "id": "JY4KDSR^5?4xwN~v?f/j",
      "name": "@Buff/Variable/09"
    },
    {
      "id": "[g*DDUI-M={_FOIegVHe",
      "name": "@Buff/Variable/10"
    },
    {
      "id": "V9a;I}Z|I5x2~dZwmzDO",
    ...
    {
      "id": "z@rY[Wxr;`rD/t[dxWa8",
      "name": "@Skill/Variable/09"
    },
    {
      "id": "VV[I2kd+O:x?D^5rR*N8",
      "name": "@Skill/Variable/10"
    },
    {
      "id": "c/o9a75!Vx!3Qlli8cMa",
      "name": "@Skill/Trait/ResetOnKill"
    },
    {
      "id": "EpU=%dT`h:5vh;[8LZsJ",
      "name": "@Map/Player/InitBuff1"
    },
    {
      "id": "?0t0mKENo^?(nm5G*YGr",
      "name": "@Map/Player/InitBuff2"
    },
    {
      "id": "_K}_fFOd#kc`4*E?Il:7",
      "name": "@Map/Player/InitBuff3"
    },
    {
      "id": "^VO/9gp+2WxVEjPjV?wm",
      "name": "@Map/Player/InitUseSkill1"
    },
    {
      "id": "(T98Pq?Mtj~_P6^r7Jum",
      "name": "@Map/Player/InitUseSkill2"
    },
    {
      "id": "~BlRNLs0}7pjkB.Vhz~[",
