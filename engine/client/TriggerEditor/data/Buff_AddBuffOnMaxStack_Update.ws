{
  "blocks": {
    "blocks": [
      ...
      {
        "id": "e`fluW1o(}*Xf+I+QkWm",
        "inputs": {
          "DO0": {
            "block": {
              "id": "pu{1FQN6Fo=r$(T6s3Kp",
              "type": "return"
            }
          },
          "IF0": {
  ...
  "metadata": {
    "name": "Buff_AddBuffOnMaxStack_Update",
    "period": "15",
    "triggerType": "1"
  },
  "scroll": {},
