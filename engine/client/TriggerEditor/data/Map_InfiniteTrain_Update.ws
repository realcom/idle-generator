{
                                ...
                                "next": {
                                  "block": {
                                    "fields": {
                                      "TYPE": "board",
                                      "VAR": {
                                        "id": "7z,d~6B3Shw(+a79CWco"
                                      }
                                    },
                                    "id": "7v,`mxH1l]tst]M_]B;`",
                                    "inputs": {
                                      "VALUE": {
                                        "block": {
                                          "fields": {
                      ...
                      "next": {
                        "block": {
                          "fields": {
                            "TYPE": "board",
                            "VAR": {
                              "id": "A*r+M;z^b03Hq^itG6DP"
                            }
                          },
                          "id": "6jo6^4#.2pJBKN+QYYsA",
                          "inputs": {
                            "VALUE": {
                              "block": {
                                "fields": {
                          ...
                          "next": {
                            "block": {
                              "fields": {
                                "TYPE": "board",
                                "VAR": {
                                  "id": "Ew|8AcQ$3n#fB#ZNcSA+"
                                }
                              },
                              "id": "mh]xbg#f*:EFYWLZISvd",
                              "inputs": {
                                "VALUE": {
                                  "block": {
                                    "fields": {
                                                        ...
                                                        "DO0": {
                                                          "block": {
                                                            "fields": {
                                                              "TYPE": "board",
                                                              "VAR": {
                                                                "id": "f+at{8a9}m|O+DN$58g!"
                                                              }
                                                            },
                                                            "id": ",sa79t5q-^JeQm@wAk^s",
                                                            "inputs": {
                                                              "VALUE": {
                                                                "block": {
                                                                  "fields": {
                                                            ...
                                                            "next": {
                                                              "block": {
                                                                "fields": {
                                                                  "TYPE": "board",
                                                                  "VAR": {
                                                                    "id": "i,;VmHtW5{zT,?nB*!ps"
                                                                  }
                                                                },
                                                                "id": "5!zW4If%_*}AH:sOsS-,",
                                                                "inputs": {
                                                                  "VALUE": {
                                                                    "block": {
                                                                      "fields": {
        ...
        "inputs": {
          "DO0": {
            "block": {
              ...
              "id": "PAE^95cML1-se6M:Z^h;",
              "inputs": {
                "TEXT": {
                  "block": {
                    "fields": {
                      "TEXT": "infinite train init"
                    },
                    "id": "mOAYr,bgT,:@P!Sa([77",
                    "type": "text"
                  }
                }
              },
                            ...
                            "block": {
                              ...
                              "next": {
                                "block": {
                                  ...
                                  "next": {
                                    "block": {
                                      "id": "aC(BN50HfB/0.nb-/$bh",
                                      "inputs": {
                                        "DO": {
                                          "block": {
                                            "id": "c3a@4/ojriNSTFrnUE$f",
                                            "inputs": {
                                              "DO0": {
                                                "block": {
                                                  "fields": {
                                              ...
                                              "IF0": {
                                                "block": {
                                                  ...
                                                  "id": "GP]=jq8]3=r8|%vMBH]0",
                                                  "inputs": {
                                                    "A": {
                                                      "block": {
                                                        "extraState": "<mutation itemCount=\"1\" metadata=\"[{&quot;comment&quot;:&quot;Achievement Data Id (필수)&quot;,&quot;name&quot;:&quot;AchievementDataId&quot;}]\"></mutation>",
                                                        "fields": {
                                                          "NAME": "boardMethod:GetAchievementState",
                                                          "THIS": false
                                                        },
                                                        "id": "}.E7UV8Fr@`-kg,vCMn-",
                                                        "inputs": {
  ...
  "variables": [
    ...
    {
      "id": "(YfV1ahc~fN@gz+.`^PH",
      "name": "@Map/InitBuffToMonsterID01"
    },
    {
      "id": "A[oZG+Rq@2$*_y/8V!hC",
      "name": "@Map/InitBuffToMonsterID02"
    },
    {
      "id": "2G]RG]]8V-JrwMsfG1Dc",
      "name": "@Map/InitBuffToMonsterID03"
    },
    {
      "id": "j[BUu9/eK}9,r{#(Hdp^",
      "name": "@Map/InitBuffToMonsterID04"
    },
    {
      "id": "t$r2C3ca4!0Gkocw*D8Z",
      "name": "@Map/InitBuffToMonsterID05"
    },
    {
      "id": "A*r+M;z^b03Hq^itG6DP",
    ...
    {
      "id": "?3B3jn*c.yC)B@Zb@dlw",
      "name": "@Map/AddBuffToBossID03"
    },
    {
      "id": "Onn.nB$^(Oq8}-AZm@9f",
      "name": "@Map/AddBuffToBossID04"
    },
    {
      "id": "v$9V^cmk-)eUl6]pz41T",
