{
  "blocks": {
    "blocks": [
      ...
      },
      {
        ...
        "id": "W=A^#|b+rD?VVY@2+X=y",
        "inputs": {
          "TEXT": {
            "block": {
              "fields": {
                "TEXT": "buff variable 10 -"
              },
              "id": "(SB_1eCEa#A!H`udsBZs",
              "type": "text"
            }
          },
          "VAR": {
              ...
              "DO0": {
                "block": {
                  "fields": {
                    "TYPE": "board",
                    "VAR": {
                      "id": "`lQ|VW34fG_)W:)4S$3k"
                    }
                  },
                  "id": "[nZ+3ZYq(hE*:b7fOpKZ",
                  "inputs": {
                    "VALUE": {
                      "block": {
                        "extraState": "<mutation></mutation>",
  ...
  "metadata": {
    "name": "Buff_AddHpToMonsterNextWave_Update",
    "period": "15",
    "triggerType": "1"
  },
  "scroll": {},
  "variables": [
    ...
    {
      "id": "=j1:dJ4aV;``9G4r^A(G",
      "name": "@Map/AddBuffToMonsterID01"
    },
    {
      "id": "2lW2-|erSH0N|(3VBJFC",
    ...
    {
      "id": "`~q[i[O8n6$jW,o@E`$X",
      "name": "@Map/AddBuffToBossID03"
    },
    {
      "id": "$D7+KFPd0DRYqWl#I_~x",
      "name": "@Map/AddBuffToBossID04"
    },
    {
      "id": "fX9m~HnO[og@BY|cF?WL",
      "name": "@Map/AddBuffToBossID05"
    },
    {
      "id": "$z05+y85hEj@iiqMgSNQ",
      "name": "@Map/NextMapDataId"
    },
    {
      "id": "Z$;xF7A*wk(`|_x0Ql/l",
      "name": "@Map/Progress"
    },
    {
      "id": "eWH.(/*#W2hwbMasq=c|",
    ...
    {
      "id": "mW%N;~d]-HX8e(:t#PtI",
      "name": "@Skill/Variable/05"
    },
    {
      "id": "I6Z*yzZ0L1x.^iK%PeWH",
      "name": "@Skill/Variable/06"
    },
    {
      "id": "B|.Qin4O7ZJ~PcK-!v)A",
    ...
    {
      "id": "jO^+tvL/N|7t/JcA31VI",
      "name": "@Skill/Variable/10"
    },
    {
      "id": "wW}W*N7r}3q82$AxV]D9",
