...
namespace Commons.Types.Units.DamageTypeStat
{
    ...
    {
        private readonly FixedFloat[] _values = new FixedFloat[(int)DamageTypeStatType.Count];
        
        public FixedFloat this[DamageTypeStatType type]
        {
        ...
        public void Apply(AddDamageTypeStat addStat, int level)
        {
