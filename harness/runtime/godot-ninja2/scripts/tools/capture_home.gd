...
const OUTPUT_PATHS := [
	"res://screenshots/godot-ninja2-home-window.png",
	"res://screenshots/godot-ninja2-home-fullscreen.png",
]
...
func _capture() -> void:
	...
	for output_path in OUTPUT_PATHS:
		var output := ProjectSettings.globalize_path(str(output_path))
	...
	print("godot-ninja2 home capture: %s" % ", ".join(saved_paths))
	quit(0)
