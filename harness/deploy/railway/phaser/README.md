...
The Docker image compiles `mushroomer` during build and serves:

- `/idlez-phaser.html`
- `/build/mushroomer/*.json`
...
python3 harness/tools/railway_phaser_deploy.py --service phaser-web --environment production
